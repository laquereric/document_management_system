class Layout::Dashboard::StatsCardComponent < ApplicationComponent
  ...
  def render_icon_path(icon)
    ...
    when 'trending-up'
      '<path d="M1.75 1.75a.75.75 0 0 0-1.5 0v9.5c0 .414.336.75.75.75h9.5a.75.75 0 0 0 0-1.5H2.5V1.75a.75.75 0 0 0-1.5 0Zm14.28 2.72a.751.751 0 0 0-1.06 0L10 10.939 4.28 5.22a.751.751 0 0 0-1.06 1.06l6.25 6.25a.75.75 0 0 0 1.06 0l3.25-3.25a.75.75 0 0 0 0-1.06Z"></path>'.html_safe
    when 'trending-down'
      '<path d="M1.75 1.75a.75.75 0 0 0-1.5 0v9.5c0 .414.336.75.75.75h9.5a.75.75 0 0 0 0-1.5H2.5V1.75a.75.75 0 0 0-1.5 0Zm14.28 2.72a.751.751 0 0 0-1.06 0L10 10.939 4.28 5.22a.751.751 0 0 0-1.06 1.06l6.25 6.25a.75.75 0 0 0 1.06 0l3.25-3.25a.75.75 0 0 0 0-1.06Z"></path>'.html_safe
    when 'dash'
      '<path d="M2 7.75A.75.75 0 0 1 2.75 7h10.5a.75.75 0 0 1 0 1.5H2.75A.75.75 0 0 1 2 7.75Z"></path>'.html_safe
    when 'calendar'
      '<path d="M4.75 0a.75.75 0 0 1 .75.75V2h5V.75a.75.75 0 0 1 1.5 0V2h1.25c.966 0 1.75.784 1.75 1.75v11.5A1.75 1.75 0 0 1 13.25 17H2.75A1.75 1.75 0 0 1 1 15.25V3.75C1 2.784 1.784 2 2.75 2H4V.75A.75.75 0 0 1 4.75 0Zm0 3.5h8.5a.25.25 0 0 1 .25.25V6h-11V3.75a.25.25 0 0 1 .25-.25H2.5v.75a.75.75 0 0 0 1.5 0V3.5Zm-2 4.25h11v7.5a.25.25 0 0 1-.25.25H2.75a.25.25 0 0 1-.25-.25v-7.5Z"></path>'.html_safe
    else
